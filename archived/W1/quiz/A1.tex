...
\begin{enumerate}
	...
	\begin{itemize}
		...
		\item[b)] \textcolor{BrickRed}{Serves as the entry point where program execution begins}
	...
	\begin{itemize}
		...
		\item[d)] \textcolor{BrickRed}{Translates C++ code into machine code}
	\end{itemize}
	\vspace{1em}
	...
	\begin{itemize}
		\item[a)] \textcolor{BrickRed}{A \texttt{.cpp} file, plus the content of any files \textcolor{BurntOrange}{\texttt{\#include}}d}
	...
	\begin{itemize}
		...
		\item[b)] \textcolor{BrickRed}{Linking error}
	...
	\begin{itemize}
		\item[a)] \textcolor{BrickRed}{The contents of \texttt{vector}}
		\item[b)] \textcolor{BrickRed}{The contents of \texttt{chrono}}
		\item[c)] \textcolor{BrickRed}{The source code in \texttt{regex.hpp}}
		\item[d)] The source code in \texttt{regex.cpp}
		\item[e)] The integer \texttt{MAX\_ITER} = 1000
		\item[f)] \textcolor{BrickRed}{The integer \texttt{FORCEINLINE} = 1}
		\item[g)] The integer \texttt{STATUS} = 2
		\item[h)] \textcolor{BrickRed}{The function \texttt{main}}
	...
	\begin{itemize}
		...
		\item[b)] \textcolor{BrickRed}{\texttt{1, 2, 4, 8}}
	...
	\item What is the maximum value representable by a \texttt{std::uint16\_t}? \begin{itemize}
		\item[a)] 32,767
		\item[b)] 32,768
		\item[c)] \textcolor{BrickRed}{65,535}
		\item[d)] 65,536
	\end{itemize}
\end{enumerate}
